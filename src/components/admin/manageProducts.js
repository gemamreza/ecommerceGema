...
class CustomPaginationActionsTable extends React.Component {
    ...
    .map((val) => {
        return(
          ...
          <TableRow key={val.id}>
            ...
            <TableCell>
              <Button animated color='linkedin' onClick={() => this.onBtnEditClick(val)}>
  ...
  onBtnSave = () => {
    ...
    .then((res) => {
      this.getDataApi()
      swal('Edit Status','Edit Data Sukses', 'success')
      this.setState({isEdit : false, editItem : {}})
    })
    .catch((err) => {
      console.log(err)
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              ...
              <Input ref={ref => this.harga = ref} className='mt-2 ml-2 mb-2' labelPosition='right' type='text' placeholder='Amount'>
              ...
              <Button animated color='linkedin' onClick={this.btnOnAdd} className='mt-2 ml-2 mb-2'>
      ...
      <Paper className='mt-3'>
        <Table>
          ...
          <TableBody>
            <TableRow>
              <TableCell>
              <Input ref={ref => this.namaEdit = ref} className='mt-2 ml-2 mb-2' placeholder={nama}></Input>
              <Input ref={ref => this.hargaEdit = ref} className='mt-2 ml-2 mb-2' labelPosition='right' type='text' placeholder={harga}>
                <Label basic>Rp.</Label>
                <input />
                <Label>.00</Label>
              </Input>
              <Input ref={ref => this.discountEdit = ref} className='mt-2 ml-2 mb-2' placeholder={discount}></Input>
              <Input ref={ref => this.categoryEdit = ref} className='mt-2 ml-2 mb-2' placeholder={category}></Input>
              <Input ref={ref => this.imgEdit = ref} className='mt-2 ml-2 mb-2' placeholder={img}></Input>
              <Input ref={ref => this.deskripsiEdit = ref} className='mt-2 ml-2 mb-2' placeholder={deskripsi}></Input>
              <Button animated color='linkedin' onClick={this.onBtnSave} className='mt-2 ml-2 mb-2'>
              ...
              <Button animated color='red' onClick={this.onBtnCancel} className='mt-2 ml-2 mb-2'>
